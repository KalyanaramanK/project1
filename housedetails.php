          ...
          <div class="single_action">
            ...
            <?php
             ...
             <div class="dropdown">
                ...
                <a class="btn btn-success" href="feedback1.php?ownerid=<?php echo Session::get('user_id'); ?>">Feedback view</a>
...
include("email.php");
extract($_REQUEST);
$qs=mysqli_query($connect,"select * from tbl_user where id='$tenant_id'");
...
$q=mysqli_query($connect,"select * from tbl_user where id='$owner_id'");
...
if(isset($accept))
{
            ...
            $mess1="Owner($full)  has Confirmed for your Booking.";
...
<?php if(Session::get('user') == 'tenant'){ ?>
          <div class="single_action">
            ...
            <?php }else if($check=='yes'){ 
              ?>
              <script>
                window.location.href="intimation.php?ownerid=<?php echo $ownerid;?>&houseid=<?php echo $houseid;?>";
              </script>
            ...
            <?php }else if($check=='booked'){ ?>
                ...
                <a class="btn btn-success" href="feedback.php?ownerid=<?php echo $ownerid;?>&houseid=<?php echo $houseid;?>">Feedback</a>
...
<form class="d-inline-block w-100" action="calc.php" method="post">
      ...
      <button type="submit" value="submit" name="calc" class="btn btn-danger mt-4">Calculate</button>
  </form>
  </div>
